...
1. Скачайте `SC_Mod_Launcher_2.0.6.zip` на странице [Releases](https://github.com/johnniewalker89/my-game-modding/releases/tag/sc-mod-launcher-v2.0.6).
2. Откройте архив и извлеките из него папку `SC_Mod_Launcher` в удобное место. Не используйте внешнюю папку `SC_Mod_Launcher_2.0.6` как рабочую.
...
SHA-256 релиза `2.0.6`:

```text
4361E9027F12DDA4FE165D85372795AD9AFD65465C6CBF81B3F7F226F588B2F4
```
