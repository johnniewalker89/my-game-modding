...
1. Скачайте `SC_Mod_Launcher_2.1.0.zip` на странице [Releases](https://github.com/johnniewalker89/my-game-modding/releases/tag/sc-mod-launcher-v2.1.0).
2. Откройте архив и извлеките из него папку `SC_Mod_Launcher` в удобное место. Не используйте внешнюю папку `SC_Mod_Launcher_2.1.0` как рабочую.
...
SHA-256 релиза `2.1.0`:

```text
50B37364EF50B249D9659146158A4EE142AEC7D9B9B5C031B99611470CEB176E
```
