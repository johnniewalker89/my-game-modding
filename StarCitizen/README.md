...
2. Скачайте `SC_Mod_Launcher_1.0.8.zip` на странице [Releases](https://github.com/johnniewalker89/my-game-modding/releases/tag/sc-mod-launcher-v1.0.8).
3. Откройте архив и извлеките из него папку `SC_Mod_Launcher` в удобное место. Не используйте внешнюю папку `SC_Mod_Launcher_1.0.8` как рабочую.
...
SHA-256 релиза `1.0.8`:

```text
6045B86852F187AFC44703AF70E3946392E56E517E049A38607CE0AA6D24EBCE
```
