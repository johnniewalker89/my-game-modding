...
- `Майнинг и крафт`: ресурсы по способам добычи для планет, лун, кластеров, mining-баз и станций, состав предметов, ТТХ оружия/компонентов Erkul, фильтры семейств рецептов, бонусы переработки и скупка сырой руды на refinery-станциях.
- `Квесты и рецепты`: чертежи в наградах, метки `[Ч]`, `[Ч?]`, `[А]`, `[С]`, репутация, farm-подсветка и Wikelo-подсказки в предметах.
...
1. Скачайте `SC_Mod_Launcher_2.1.4.zip` на странице [Releases](https://github.com/johnniewalker89/my-game-modding/releases/tag/sc-mod-launcher-v2.1.4).
2. Откройте архив и извлеките из него папку `SC_Mod_Launcher` в удобное место. Не используйте внешнюю папку `SC_Mod_Launcher_2.1.4` как рабочую.
...
SHA-256 релиза `2.1.4`:

```text
7CC1DF842C683E3183C04CA3AFBD817843B338F7F02EF4AF49D3FEAA4B1FE0B1
```
...
- `[Ч?]` — общий заголовок у смешанных вариантов, где не каждый вариант содержит выбранный чертёж.
...
На планетах, лунах, астероидных кластерах, mining-базах и станциях показываются ресурсы по способам добычи и рецепты предметов, которые можно собрать из местных ресурсов. На refinery-станциях можно включить подсказки по бонусам и штрафам переработки.
