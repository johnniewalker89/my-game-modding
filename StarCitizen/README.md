...
1. Скачайте `SC_Mod_Launcher_2.1.2.zip` на странице [Releases](https://github.com/johnniewalker89/my-game-modding/releases/tag/sc-mod-launcher-v2.1.2).
2. Откройте архив и извлеките из него папку `SC_Mod_Launcher` в удобное место. Не используйте внешнюю папку `SC_Mod_Launcher_2.1.2` как рабочую.
...
SHA-256 релиза `2.1.2`:

```text
4D4A588409D1CF39FAF322E968AF6573766A1A8D441649F1B4F7402AC3BE1A43
```
