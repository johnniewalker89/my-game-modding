...
- `Русификатор`: установка, обновление, удаление RuSC и установка из локального ZIP. SC Mod Launcher использует перевод ру сообщества [StarCitizenRu](https://github.com/n1ghter/StarCitizenRu) и точечно дополняет его под свои модули.
...
1. Скачайте `SC_Mod_Launcher_2.0.2.zip` на странице [Releases](https://github.com/johnniewalker89/my-game-modding/releases/tag/sc-mod-launcher-v2.0.2).
2. Откройте архив и извлеките из него папку `SC_Mod_Launcher` в удобное место. Не используйте внешнюю папку `SC_Mod_Launcher_2.0.2` как рабочую.
...
SHA-256 релиза `2.0.2`:

```text
16525CE96196DFACD207B75D26338577CBBD45F1F60843F755613E741D34A1C8
```
